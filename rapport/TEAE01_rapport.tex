...
eller anseende av någon anledning skulle kunna ses som negativt. Det som kan anmärkas på men som vi inte har bekräftat är de uppgifter om att löner för mer lågavlönade läggs under en marknadsmässig nivå medan lönen för verkställande direktör har lagts högre än vad som är vanligt för kommunalt ägda bolag. Bland de anställda är ungefär en tredjedel kvinnor, och i ledningen endast en tiondel. Det ska finnas goda möjligheter till utveckling på bolaget, några bra exempel på det har vi inte hittat men då bolaget är stort med flera olika verksamheter verkar det troligt att det ska vara möjligt att göra karriär inom bolaget.
Baserat på detta anser vi att Tekniska verken är en god arbetsgivare som uppfyller våra krav som Civilingenjörer.
