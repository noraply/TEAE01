...
i Linköping AB, org. nr: 556004-9727.
...
sektorer, potentiella kunder ser dem som ett trovärdigt alternativ. 
...
som avfallsindustrin, tidigare i princip ett nödvändigt ont, och inte bara tjäna 
pengar på den, men också lyckats utvinna nytta.
...
\begin{table}[H]
	...
	\end{tabular}
	\caption{Nyckeltal avseende 2012, siffror i tusental kronor om annat ej anges.}
	\label{table:nyckeltal}
\end{table}

\subsubsection{Jämförelse över tid} 
Som kan ses i figur \ref{fig:jamfor} har Tekniska verkens nyckeltal legat förhållandevis konstanta under de senaste åren. Man kan se en stadigt ökande tränd vad gäller soliditeten medan antalet anställda flukturerat något, men ökat över tid.
\begin{figure}[H] 
