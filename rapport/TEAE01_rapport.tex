...
\begin{itemize}
	...
	\item \textbf{Avfall:} 
		%%Okänt? Är det inte till stor del ett enda jävla monopol?
	\item \textbf{El och vatten:} 
		Tekniska verkens dotterbolag Bixia har ca 300 000 kunder vilket är %%Hurdå stor del av marknaden? vilka andra är störst? 
